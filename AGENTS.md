...
This file tells Codex how to work on this project.
...
Every 3–4 phases, a dedicated health check session runs: lint to zero, dead code removal, `npm audit`, `npx depcheck`, git branch cleanup, env var audit, TODO sweep, and AGENTS.md freshness check.

## Key Files

- `AGENTS.md` — CC reads this automatically. Project conventions and architecture.
