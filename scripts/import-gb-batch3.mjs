// Import the GB city-grid scrape (batch 3): 20 Apify datasets from
// scripts/gb-runs-batch3.json → discovered_shops with country_code='GB'.
...
//
// Existing GB rows from batches 1+2 (8,555 total) are preserved on conflict
...
//
// Run with:
//   node scripts/import-gb-batch3.mjs
...
const runsPath = join(__dirname, 'gb-runs-batch3.json')
...
function processItem(item) {
  ...
  return {
    ...
    raw_data: { search_term: item.searchString || null, batch: 'batch3-2026-04-29' },
  }
}
