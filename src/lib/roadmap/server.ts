...
/**
 * Resolve the authenticated user + their workspace, matching the auth/membership
 * guard used across the API (see src/app/api/tasks/route.ts). Returns either
 * { supabase, userId, workspaceId } or { error } with a ready NextResponse.
 */
